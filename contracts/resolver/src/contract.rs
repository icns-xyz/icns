...
use registry::msg::{IsAdminResponse, QueryMsg as QueryMsgRegistry};
...
pub fn instantiate(
    ...
    let cfg = Config { registry_address };
...
pub fn execute(
    ...
    match msg {
        ExecuteMsg::SetRecord {
            user_name,
            addresses,
        } => execute_set_addresses(deps, env, info, user_name, addresses),
    }
}
...
mod tests {
    ...
    fn mock_init(deps: DepsMut, registry_addr: String) {
